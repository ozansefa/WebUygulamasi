<?php
    ...
    if($_POST){
      ...
      $sorgu = $con -> prepare('INSERT INTO teacher (teacher_name, teacher_email, teacher_passwd) VALUES (?,?,?)');
...
<body>
  ...
  <div class="container">
    <a class="navbar-brand" href="#">Öğretmen Ekle</a>
    ...
    <div class="container pt-5">
        <div class="d-flex">
            <h1 class="me-auto">Öğretmen Ekle</h1>
            <div>
                <a class="btn btn-success" href="icerik.php"><i class="fas fa-backward"></i></i> Geri Gel</a>
            </div>    
        </div>
        <form action="ogretmenOlustur.php" method="POST">
        <div class="mb-3">
              <label>Öğretmen Adı</label><span class="text-danger"></span>
              <input class="form-control" type="text" name="ogr_adi" required>
          </div>
          <div class="mb-3">
              <label>Öğretmen Maili</label><span class="text-danger"></span>
