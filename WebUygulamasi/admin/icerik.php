                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li class="submenu">
                                <a href="javascript:;">Kullanıcı Ekle</a>
                                <ul>
                                    <li><a href="ogretmenOlustur.php">Öğretmen</a></li>
                                    <li><a href="ogrenciOlustur.php">Öğrenci</a></li>
                                </ul>
                            </li>
                            <li class="submenu">
                                <a href="javascript:;">Kullanıcılar</a>
                                <ul>
                                    <li><a href="ogretmenGoruntule.php">Öğretmen</a></li>
                                    <li><a href="ogrenciGoruntule.php">Öğrenci</a></li>
                                </ul>
                            </li>
                            <li class="scroll-to-section"><a href="logout.php">Çıkış Yap</a></li>
          ...
          <div class="item">
            <div class="img-fill">
                ...
                <div class="text-content">
                  <h3>Admin Sayfasıdır</h3>
                  <h5>Admin: Kullanıcı Ekler - Siler - Görüntüler</h5>
            ...
            <div class="row">
                <div class="col-lg-6 col-xs-12">
                    <div class="left-text-content">
                        <p>Copyright &copy; 2021 Sefa Co., Ltd. 
