...
-->
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="#top" class="active">Raporlar</a></li>
                            <li class="scroll-to-section"><a href="ogretmen.php">Projeler</a></li>
    ...
    <div id="search">
        ...
        <form id="contact" action="#" method="get">
            <fieldset>
                <input type="search" name="q" placeholder="Proje Ara" aria-label="Search through site content">
            </fieldset>
            <fieldset>
