<?php
    ...
    $sorgu = $con -> prepare('SELECT p.id, p.proje_isim, p.proje_keyword, p.proje_icerik, t.teacher_name FROM project p INNER JOIN teacher t on p.ogretmen_id=t.id
    ');
    $sorgu -> execute();
  ...
  <div class="container">
    ...
    <div class="container pt-5">
        <div class="d-flex">
            ...
            <div>
                <a class="btn btn-success" href="index.php">Ana Sayfaya Dön</a>
            </div>    
        </div>
                ...
                <?php
                    foreach($odevler as $key => $value){  ?>
                        <tr>
                            ...
                            <td class="text-end">
                              <a class="btn btn-sm btn-primary" href="projeSec.php?odev_no=<?=$value['id'] ?>">
                              <i class="fas fa-edit"></i> İstekte Bulun</a>
                            </td>
                        </tr>
                <?php } ?>
            </tbody>
