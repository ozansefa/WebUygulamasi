...
-->
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Menu Start ***** -->
                        <ul class="nav">
                            <li class="scroll-to-section"><a href="upload.php">Rapor Ekle</a></li>
                            <li class="scroll-to-section"><a href="ogrenciler.php">Projeler</a></li>
                            <li class="submenu">
                                <a href="javascript:;">Rapor</a>
                                <ul>
                                    <li><a href="upload.php">Ekle</a></li>
    ...
    <div id="search">
        ...
        <form id="contact" action="search.php" method="post">
            <fieldset>
                <input type="search" name="search" placeholder="Rapor Ara" aria-label="Search through site content">
            </fieldset>
            <fieldset>
